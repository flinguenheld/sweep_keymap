...
combo_t key_combos[] = {
    ...
    [CIRCUMFLEX] = COMBO(combo_circumflex,                  CS_CIRCUMFLEX),
    ...
    [GRAVE] = COMBO(combo_grave,                            CS_GRAVE),
    ...
    [QUOTE] = COMBO(combo_quote,                            CS_QUOTE),
    [QUOTE_DOUBLE] = COMBO(combo_quote_double,              CS_QUOTE_DOUBLE),
    [SEMICOLON] = COMBO(combo_semicolon,                    KC_SEMICOLON),
    [SLASH] = COMBO(combo_slash,                            KC_SLSH),
    [STAR] = COMBO(combo_star,                              KC_ASTR),
    [TILDE] = COMBO(combo_tilde,                            CS_TILDE),
