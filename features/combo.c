...
/* -- */
const uint16_t PROGMEM combo_ampersand[] = {KC_E, KC_A, COMBO_END};
...
const uint16_t PROGMEM combo_exclamation_mark[] = {KC_Q, KC_K, COMBO_END};
const uint16_t PROGMEM combo_grave[] = {KC_T, KC_G, COMBO_END};
const uint16_t PROGMEM combo_hash[] = {KC_X, KC_A, COMBO_END};
const uint16_t PROGMEM combo_minus[] = {KC_T, KC_R, COMBO_END};
const uint16_t PROGMEM combo_percent[] = {KC_B, KC_A, COMBO_END};
...
const uint16_t PROGMEM combo_quote_double[] = {KC_U, KC_A, COMBO_END};
...
const uint16_t PROGMEM combo_tilde[] = {KC_I, KC_A, COMBO_END};
...
const uint16_t PROGMEM combo_bracket_right[] = {KC_O, KC_A, COMBO_END};
const uint16_t PROGMEM combo_curly_bracket_left[] = {KC_X, KC_E, COMBO_END};
const uint16_t PROGMEM combo_curly_bracket_right[] = {KC_E, KC_K, COMBO_END};
...
/* Non qwerty */
const uint16_t PROGMEM combo_euro[] = {KC_X, KC_Y, COMBO_END};
